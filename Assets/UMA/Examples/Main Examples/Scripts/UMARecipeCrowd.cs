	...
	public GameObject GenerateOneCharacter()
	{
		...
		else
		{
			if (hideWhileGenerating)
			{
				...
				{
					//HACK: V and Mark customizing
					generatedData.gameObject.AddComponent<Wander> ();
					generatedData.gameObject.GetComponent<CharacterController> ().center = new Vector3 (0.0f, 1.0f, 0.0f);
